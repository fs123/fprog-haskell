...
>  ((Const 3) `Add` (Const 4)) `Add` ((Const 5) `Add` (Const 2))
...
> simpl (Mult l (Cont 0)) = Const 0
> simpl (Mult l (Cont 1)) = simpl l
> simpl (Mult (Cont 0) r) = Const 0
> simpl (Mult (Cont 1) r) = simpl r
> simpl (Mult l r) = Mult (simpl l) (simpl r)
> simpl e = e

Problem: Hier funktioniert die Simplifikation nur im Abstieg der Rekursion,
nicht aber wenn das Resultat einer Simplifikation wieder vereinfacht werden könnte.
...
>   simplD e                 = e
>   simplU (Add (Const 0) r) = r                   -- 0 + r
>   simplU (Add l (Const 0)) = l                   -- l + 0
>   simplU (Mul (Const 1) r) = r                   -- 1 * r
>   simplU (Mul l (Const 1)) = l                   -- l * 1
>   simplU (Mul (Const 0) r) = Const 0             -- 0 * r
>   simplU (Mul l (Const 0)) = Const 0             -- l * 0
>   simplU e = e
